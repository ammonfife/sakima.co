...
Control tmux sessions by sending keystrokes and reading output. Essential for managing Codex sessions.

## When to Use

✅ **USE this skill when:**

- Monitoring Codex/Codex sessions in tmux
...
For interactive TUIs (Codex, Codex, etc.), split text and Enter into separate sends to avoid paste/multiline edge cases:
