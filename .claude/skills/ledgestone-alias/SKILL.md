---
name: ledgestone-alias-generator
description: Standard workflow for generating, persisting, and routing unique @ledgestonehome.com aliases for new signups and login recovery
...
- Save the alias before submitting it to any external form when possible.
